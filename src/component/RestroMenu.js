...
const RestroMenu = () => {
 const {resId} =useParams();
  ...
  const menuData = async () => {
    const data = await fetch(`https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=19.82357895711519&lng=75.29264766722918&restaurantId=${resId}&catalog_qa=undefined&submitAction=ENTER`);
